...
{{- define "ack-elbv2-controller.app.name" -}}
...
*/}}
{{- define "ack-elbv2-controller.app.fullname" -}}
...
{{- define "ack-elbv2-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-elbv2-controller.service-account.name" -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}

{{- define "ack-elbv2-controller.watch-namespace" -}}
...
{{- define "ack-elbv2-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}

{{/* The path the shared credentials file is mounted */}}
{{- define "ack-elbv2-controller.aws.credentials.path" -}}
{{ $secret_mount_path := include "ack-elbv2-controller.aws.credentials.secret_mount_path" . }}
...
{{- define "ack-elbv2-controller.feature-gates" -}}
{{- $list := list -}}

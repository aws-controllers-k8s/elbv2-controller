...
const (
	FinalizerString = "finalizers.elbv2.services.k8s.aws/Listener"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("listeners")

...
const (
	FinalizerString = "finalizers.elbv2.services.k8s.aws/LoadBalancer"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("loadbalancers")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.LoadBalancer{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.LoadBalancer),
	}
}

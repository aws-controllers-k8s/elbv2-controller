...
const (
	finalizerString = "finalizers.elbv2.services.k8s.aws/TargetGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("targetgroups")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.TargetGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TargetGroup),
	}
}
